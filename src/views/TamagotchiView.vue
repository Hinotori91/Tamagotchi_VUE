...
<script setup>
import TamaSpriteSheet from '@/components/Tamagotchi/TamaSpriteSheet.vue'
...
console.log(store.buttons[0].image);


  const emit = defineEmits(['ananasBtn', 'apfelBtn', 'BananeBtn', 'schlafenBtn']) 
</script>
